...
#
# Code derived from the basic Arduino library for the Gesture Sensor by Seeed:
...
class Gesture:
    ...
    GES_ENTRY_TIME = .800  # When you want to recognize the Forward/Backward gestures, your gestures' reaction time
    # must less than GES_ENTRY_TIME(0.8s).
    GES_QUIT_TIME = 1.000
    ...
    # Return a value from the gesture sensor which can be used in a program
    #       0:nothing
    #       1:Forward
    #       2:Backward
    #       3:Right
